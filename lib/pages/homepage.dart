  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: SizedBox(
          height: 150,
          child: Image.asset(AssetsPaths.homePageLogoPath),
        ),
        centerTitle: true,
        ...
        children: [
          Column(
            children: [
              Padding(
                padding:
                    AppPaddings.horizontalNormalPadding +
                    AppPaddings.topSmallPadding,
                child: Container(
                              ...
                              children: [
                                Expanded(
                                  child: DropdownButton<String>(
                                    ...
                                    hint: Text(
                                      AppStrings.districtDropDownHintText,
                                    ),
              ...
              Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  LocationPharmacyButton(
                    onPressed: () => setCityDistrictFromLocaiton(),
                  ),
                ],
              ),
            ],
          ...
          pharmacys != null
              ? Divider(color: AppColors.lightBlackColor)
              : SizedBox.shrink(),
          isLoading
              ? Expanded(
                  child: Center(
